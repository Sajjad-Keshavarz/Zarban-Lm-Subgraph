...
export class AccountManager {
  ...
  countBorrow(): void {
    this.account.borrowCount += INT_ONE;
    this.account.save();
  }

  countRepay(): void {
    this.account.repayCount += INT_ONE;
    this.account.save();
  }
  ...
  countTransfer(): void {
    this.account.transferredCount += INT_ONE;
    this.account.save();
  }
  ...
  countReceive(): void {
    this.account.receivedCount += INT_ONE;
    this.account.save();
  }

  countLiquidation(): void {
    this.account.liquidationCount += INT_ONE;
    this.account.save();
  }
